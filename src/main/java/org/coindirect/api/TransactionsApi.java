...
public class TransactionsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<Transaction> listTransactionsForWallet(Long id, String type, Integer offset, Integer max) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling listTransactionsForWallet");
    }
    // create path and map variables
