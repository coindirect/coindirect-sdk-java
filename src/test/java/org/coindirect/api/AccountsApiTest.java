...
public class AccountsApiTest {
     ...
     */
    @Test
    public void getRunningCampaignsTest() throws ApiException {
        String type = null;
        Campaign response = api.getRunningCampaigns(type);
     ...
     */
    @Test
    public void listAffiliateCodeTypesTest() throws ApiException {
        List<String> response = api.listAffiliateCodeTypes();
